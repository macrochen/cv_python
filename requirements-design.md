...
*此功能旨在帮助用户详细记录每一次真实面试的细节，以便后续复盘和总结。*

- **功能描述**：在每个机会的详情页中，用户可以添加、查看和编辑该机会下的所有面试记录。
- **交互流程**：
    1. 在“机会详情”页中新增一个“面试记录”标签页。
    2. 该标签页提供一个 **[ + 添加面试记录 ]** 按钮。
    3. 点击按钮后，弹出一个表单，允许用户填写：
        - **面试轮次** (如：技术一面、HR面、交叉面)
        - **面试日期**
        - **面试官** (可选)
        - **面试问题** (文本框，记录面试官提问)
        - **我的回答** (文本框，记录自己的回答要点)
        - **我的复盘/反思** (文本框，记录面试后的心得体会和改进点)
    4. 记录将按时间倒序排列展示。
- **核心价值**：将真实面试经验结构化存储，方便用户回顾、分析和学习，将每一次面试都转化为成长的机会。
